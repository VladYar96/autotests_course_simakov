...
class Segment:
    ...
    def x_axis_intersection(self):
        if self.point1[1] == 0 or self.point2[1] == 0:
            return True
        elif (self.point1[1] > 0 and self.point2[1] < 0) or (self.point1[1] < 0 and self.point2[1] > 0):
            return True
        else:
            return False

    def y_axis_intersection(self):
        if self.point1[0] == 0 or self.point2[0] == 0:
            return True
        elif (self.point1[0] > 0 and self.point2[0] < 0) or (self.point1[0] < 0 and self.point2[0] > 0):
            return True
        else:
            return False
